...
import { isValidStoreSlug, labelToSlug, slugToLabel } from "../../../lib/stores";
...
export default function RepairsMaintenancePage() {
  ...
  const selectedStore = isValidStoreSlug(storeSlug) ? slugToLabel(storeSlug) : "Hillcrest";
  const selectedStoreSlug = isValidStoreSlug(storeSlug) ? storeSlug : labelToSlug(selectedStore);
  ...
  }, [searchParams, selectedStoreSlug]);
